...
class ResourceCache
{
  public:
    ...
    {
      public:
        ImageStates(juce::Image normal     = juce::Image(),
                    juce::Image alternate  = juce::Image(),
                    juce::Image background = juce::Image()) :
...
#ifndef USE_PARAM
    /**
     * @brief If teragon Parameter class is not used (as  I do), a base class for all components comes handy...[esseci]
     */
    class ComponentWithCachedGraphics
    {
      public:
        ComponentWithCachedGraphics(const ResourceCache *resources,
                                    const String &imageName);
        
      protected:
        ResourceCache::ImageStates *imageStates = nullptr;
    };
#endif
