...
protected:
                       ...
                       public ComponentWithCachedGraphics
    {
     ...
     public:
        ThinButton(const ResourceCache *resources, const String &imageName);

        virtual void paint(Graphics &g);

        virtual const juce::Image getImageForButtonState() = 0;
      ...
      protected:
        ...
        JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR(ThinButton);
    };
